...
In <a href="https://www.lrz.de/en/research/research-projects/detail/hoehere-leistung-weniger-energie-zweite-generation-photonischer-prozessoren-am-lrz" target="_blank" rel="noopener noreferrer"> DAQC </a> project, we studied the efficiency of using unconventional computing devices for HPC and AI applications. Within this context, we performed several experiments on the first photonic processor developed by <a href="https://qant.com/de/" target="_blank" rel="noopener noreferrer"> Q.ANT GmbH </a>. These experiments were conducted on three servers, each initially equipped with three first-generation Native Processing Units (NPUs) and later upgraded to nine second-generation NPUs.
